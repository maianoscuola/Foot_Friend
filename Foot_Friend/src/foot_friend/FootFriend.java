...
public class FootFriend extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FootFriend().setVisible(true));
    }
    ...
    private JPanel createCreateMatchPanel() {
        ...
        SpinnerModel maxPlayersModel = new SpinnerNumberModel(2, 2, 20, 1);
